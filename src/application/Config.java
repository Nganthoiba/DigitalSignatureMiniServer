...
public class Config {
	...
	public static final String APP_PATH = HOME_PATH + File.separator + "DigiSignApp";
    ...
    public static File setConfigFile(String dllFilePath) throws IOException {
		...
		File configFile = new File(HOME_PATH + File.separator + "DigiSignApp", "epass_config.cfg");
