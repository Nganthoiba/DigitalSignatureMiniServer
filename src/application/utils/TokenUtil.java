...
public class TokenUtil {
	...
	public static Provider loadPkcs11Provider(String name, String library, int slotIndex) throws Exception {
	...
	public static Provider loadPkcs11ProviderFromFile(File configFile) throws Exception {
        ...
        if (base == null) {
            throw new RuntimeException("SunPKCS11 not available in current JDK.");
        }
